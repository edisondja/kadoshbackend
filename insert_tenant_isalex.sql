...
--   mysql -u usuario -p tenant_service < insert_tenant_isalex.sql
--
-- Acceso típico:   https://isalex.odontoed.com/   (o el subdominio que configure)
