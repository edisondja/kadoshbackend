-- =====================================================
-- SCRIPT DE CORRECCIÓN PARA ODONTOGRAMAS EN PRODUCCIÓN V3
-- Fecha: 2026-01-16
-- Autor: Edison De Jesus Abreu
-- Email: edisondja@gmail.com
-- =====================================================
-- 
-- Esta versión SOLO agrega columnas si no existen
-- NO intenta modificar columnas existentes
--
-- =====================================================
...
-- =====================================================
-- 1. PROCEDIMIENTOS PARA AGREGAR COLUMNAS
-- =====================================================
...
-- =====================================================
-- SOLO agregar columnas si no existen, NO modificar

-- Primero renombrar columnas si tienen nombres antiguos
...
IF @col_exists > 0 THEN
    ...
    IF @new_exists = 0 THEN
        ALTER TABLE `odontogramas` CHANGE COLUMN `id_paciente` `paciente_id` int(10) unsigned NOT NULL;
    END IF;
END IF;

-- Agregar columnas si no existen (sin AFTER para evitar errores)
